...
import ModalOpsErro from '../modalOpsErro/ModalOpsErro'; // Certifique-se de que o caminho está correto
...
const QRCodeModal: React.FC<QRCodeModalProps> = ({ open, handleClose, base64String }) => {
    const [isModalOpsErroOpen, setIsModalOpsErroOpen] = useState(false);

    const handleOpenModalOpsErro = () => {
        setIsModalOpsErroOpen(true);
        handleClose(); // Fecha o QRCodeModal
    };

    const handleCloseModalOpsErro = () => {
        setIsModalOpsErroOpen(false);
    };
    ...
    return (
        <>
            ...
            >
                ...
                >
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', marginTop: 'auto' }}>
                        <Button
                            onClick={handleOpenModalOpsErro}
                            sx={{
            ...
            <ModalOpsErro open={isModalOpsErroOpen} handleClose={handleCloseModalOpsErro} />
        </>
    );
};
